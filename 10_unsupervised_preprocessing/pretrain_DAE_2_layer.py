...
def main():
    ...
    layer_trainers = []
    layer_trainers.append(get_layer_trainer_sgd_autoencoder(layers[0], trainset[0] ,1 ))
    layer_trainers.append(get_layer_trainer_sgd_autoencoder(layers[1], trainset[1] ,2 ))
